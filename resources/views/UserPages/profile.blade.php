    ...
    <div class="container">
        ...
        <div class="row py-5">
            ...
            <div class="col-md-9 mt-5 mt-md-0">
                <div class="card rounded-4 p-4 p-md-5 border-0">
                    <h2 class="fw-bold">Your Profile Detail</h2>
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ url('profile/'.$userData->user_id.'/update') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="your phone number" aria-describedby="phoneHelp" aria-label="Phone number" name="user_phone" value="{{ substr($userData->user_phone, 2) }}">
                                    </div>
